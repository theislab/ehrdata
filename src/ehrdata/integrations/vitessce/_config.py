...
def optimize_and_gen_config(
    ...
    *,
    ...
    While Vitessce has many features, this function provides a convenient way for an opinionated set of illustrations to explore interactively together(called "views").
